...
public class PlayerAnimator : MonoBehaviour
{
    ...
    private void HandleGroundEffects()
    {
        ...
        var speedPoint = Mathf.InverseLerp(0, _player.Stats.MaxSpeed, Mathf.Abs(_player.Speed.x));
    ...
    private void HandleWallSlideEffects()
    {
        ...
        //_wallSlideSource.volume = _isSliding
        ...
        int GetState()
        {
            ...
            if (!_grounded)
            {
                if (_isOnWall)
                {
                    ...
                    if (_player.Speed.y > 0) return Wolf_WallRun;
                    if (_player.Speed.y == 0) return Wolf_WallIdle;
                }
            }
    ...
    private static readonly int Wolf_Idle = Animator.StringToHash("Wolf_Idle");
    private static readonly int Wolf_Run = Animator.StringToHash("Wolf_Run");

    private static readonly int Wolf_JumpUp = Animator.StringToHash("Wolf_JumpUp");
    private static readonly int Wolf_JumpPeak = Animator.StringToHash("Wolf_JumpDown");
    private static readonly int Wolf_JumpDown = Animator.StringToHash("Wolf_JumpDown");

    private static readonly int Wolf_WallIdle = Animator.StringToHash("Wolf_WallSlide");  // Same
